...
async def process_aweme_id(aweme_id):
    ...
    print(f"Found {len(all_comments)} comments for aweme_id {aweme_id}.")
    ...
    print(f"Found {len(all_replies)} replies for aweme_id {aweme_id}.")
    print(f"Found {len(all_replies) + len(all_comments)} total for aweme_id {aweme_id}.")
